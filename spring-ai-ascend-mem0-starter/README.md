...
This starter provides no new SPI interfaces. It contributes an alternative implementation of `LongTermMemoryRepository` (defined in `spring-ai-ascend-memory-starter`) that forwards calls to the Mem0 sidecar over HTTP.
