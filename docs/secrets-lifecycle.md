...
- For BYOC customers without OpenBao, K8s Secrets at `springAiAscend-platform/<secret-name>`
...
- **Audit**: rotation event = `AuditClass.SECURITY_EVENT`; `springAiAscend_secret_rotated_total{secret_name}` metric
